...
Now, we need to compute the list of duplicates. Let's first focus on the
core of the function: according to me is the more interesting and
elegant part of the program (no wonder is largely not by me, but adapted
from code I found in a post by Neil Mitchell,
[[http://neilmitchell.blogspot.it/2013/09/repeated-word-detection-with-haskell.html]["Repeated
Word Detection with Haskell"]]).
...
[[https://www.haskell.org/haskellwiki/Pointfree][pointfree]] style,
...
data structure we need for the final output. Not I need to specify two
...
You can find the complete source code in its
[[https://github.com/larsen/hledger-dupes][github repository]].
